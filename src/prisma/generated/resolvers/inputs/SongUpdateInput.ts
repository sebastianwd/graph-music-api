...
import { PlaylistUpdateOneWithoutSongsInput } from "../inputs/PlaylistUpdateOneWithoutSongsInput";
...
export class SongUpdateInput {
  ...
  @TypeGraphQL.Field(_type => PlaylistUpdateOneWithoutSongsInput, {
    nullable: true
  })
  Playlist?: PlaylistUpdateOneWithoutSongsInput | undefined;
}
